...
object GraphX {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("../UdemySparkCourse/src/main/resources/data/marvel/Marvel-names.txt")
    val verts = names.flatMap(parseNames)
    
    // Build up our edges
    val lines = sc.textFile("./UdemySparkCourse/src/main/resources/data/marvel/Marvel-graph.txt")
