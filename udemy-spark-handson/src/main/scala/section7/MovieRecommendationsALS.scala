...
object MovieRecommendationsALS {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     val lines = Source.fromFile("./UdemySparkCourse/src/main/resources/data//ml/u.item").getLines()
     for (line <- lines) {
  ...
  def main(args: Array[String]) {
    ...
    val data = sc.textFile("./UdemySparkCourse/src/main/resources/data//ml/u2.data")
