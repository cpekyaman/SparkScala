...
object LinearRegressionDataFrame {
  ...
  def main(args: Array[String]) {
    ...
    val spark = SparkSession
      ...
      .master("local[*]")
      .config("spark.sql.warehouse.dir", "file:///E:/DATA/Spark/Temp") // Necessary to work around a Windows bug in Spark 2.0.0; omit if you're not on Windows.
      .getOrCreate()
    ...
    val inputLines = spark.sparkContext.textFile("./UdemySparkCourse/src/main/resources/data/regression.txt")
